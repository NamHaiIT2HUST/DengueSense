...
export type ExplanationFactor = Schemas["ExplanationFactor"];
export type LegendClass = Schemas["LegendClass"];
export type InputDataSources = Schemas["InputDataSources"];
export type DataVersion = Schemas["DataVersion"];
export type CreateForecastRunRequest = Schemas["CreateForecastRunRequest"];
