          ...
          return (
            ...
            >
              <div
                ...
                style={{
                  borderColor: p.status === "todo" ? "var(--border-strong)" : "var(--accent)",
              ...
              <h4 className="font-display mt-0.5 text-[15px] font-semibold">{p.title}</h4>
              <div className="mt-0.5 text-[11px] text-[var(--ink-muted)]">{p.period}</div>
              <p className="mt-2 text-[13px] leading-snug text-[var(--ink-secondary)]">{p.desc}</p>
            </motion.div>
          );
        })}
      </div>
