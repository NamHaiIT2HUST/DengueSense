...
import (
	...
	"github.com/NamHaiIT2HUST/DengueSense/backend/services/surveillance/migrations"
)
...
// MigrateUp áp mọi migration chưa chạy lên schema `surveillance` (bảng theo dõi nằm cùng schema). Idempotent.
